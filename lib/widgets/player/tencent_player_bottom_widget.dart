...
import 'package:checkcar/utils/common_util.dart';
import 'package:checkcar/utils/time_util.dart';
import 'package:checkcar/utils/widget_util.dart';
import 'package:checkcar/widgets/player/tencent_player_linear_progress_indicator.dart';
import 'package:checkcar/widgets/player/triangle_painter.dart';
                    ...
                    TencentLinearProgressIndicator(
                      value: controller.value.duration.inMilliseconds <= 0
                          ...
                          : showDuration.inMilliseconds /
                              controller.value.duration.inMilliseconds,
                      valueColor:
                          AlwaysStoppedAnimation<Color>(Color(c_2a8cff)),
